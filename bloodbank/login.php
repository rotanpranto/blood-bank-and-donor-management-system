    ...
    <div class="tab-content">
       <div class="tab-pane container active" id="hospitals">
        <form action="file/donorLogin.php" method="post">
          <label class="text-muted font-weight-bold" class="text-muted font-weight-bold">Donor Nid</label>
          <input type="number" name="hemail" placeholder="Donor Nid" class="form-control mb-4">
          <label class="text-muted font-weight-bold" class="text-muted font-weight-bold">Donor Password</label>
          <input type="password" name="hpassword" placeholder="Donor Password" class="form-control mb-4">
      ...
      <div class="tab-pane container fade" id="receivers">
         <form action="file/receiverLogin.php" method="post">
          <label class="text-muted font-weight-bold" class="text-muted font-weight-bold">Receiver Nid</label>
          <input type="number" name="remail" placeholder="Receiver Nid" class="form-control mb-4">
