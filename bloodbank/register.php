    ...
    <div class="tab-content">
       ...
       <div class="tab-pane container active" id="hospitals">
        ...
        <form action="file/donorReg.php" method="post" enctype="multipart/form-data">
          <input type="text" name="hname" placeholder="Donor Name" class="form-control mb-3" required>
          <input type="text" name="hcity" placeholder="Donor City" class="form-control mb-3" required>
          <input type="number" name="hphone" placeholder="Donor Phone Number" class="form-control mb-3" required pattern="[0,6-9]{1}[0-9]{9,11}" title="Password must have start from 0,6,7,8 or 9 and must have 10 to 12 digit">
          <input type="text" name="smoking_status" placeholder="smoking status" class="form-control mb-3" required>
          <input type="number" name="hemail" placeholder="Donor nid" class="form-control mb-3" required>
          <input type="password" name="hpassword" placeholder="Donor Password" class="form-control mb-3" required minlength="6">
       ...
       <div class="tab-pane container fade" id="receivers">
         ...
         <form action="file/receiverReg.php" method="post" enctype="multipart/form-data">
          ...
          <input type="number" name="remail" placeholder="Receiver NID" class="form-control mb-3" required>
